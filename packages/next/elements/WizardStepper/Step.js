...
class Step extends Component {
  ...
  renderLineRight() {
    if (this.props.lineRight) {
      return <div style={this.state.lineRightStyle} className="line-right-stepper-wizard"></div>;
    } else {
      return null;
    }
  }
  renderLineLeft() {
    if (this.props.lineLeft) {
      return <div style={this.state.lineLeftStyle} className="line-left-stepper-wizard"></div>;
    } else {
      return null;
    }
  }
    ...
    return (
      <div style={this.state.steperOuterStyle} className="step-outer-stepper-wizard">
        <div
          ...
          className="shape-stepper-wizard"
          onClick={this.setCurrentStep}
        >
          <i style={this.state.shapeContentStyle} className={`shapeContent fa ${this.props.step.icon}`}>
