...
.widget-calendar .fc.fc-direction-ltr .fc-dayGridMonth-view .fc-daygrid-day-top .fc-daygrid-day-number {
  padding: 0 !important;
}
.widget-calendar .fc.fc-direction-ltr .fc-daygrid-event.fc-event-start, .widget-calendar .fc.fc-direction-rtl .fc-daygrid-event.fc-event-end {
  margin-right: 2px;
  margin-left: 2px;
}
...
.fc .fc-h-event .fc-event-title-container .fc-event-title {
  overflow: hidden;
  text-overflow: ellipsis;
  white-space: nowrap;
}
...
.fc.fc-theme-standard .fc-scrollgrid-section-body > td {
  border: 0;
}
...
.fc th.fc-col-header-cell a, .fc th.fc-col-header-cell a:hover {
  color: #8898aa;
}
.fc th.fc-col-header-cell .fc-col-header-cell-cushion {
  padding: 0;
}
.fc * {
  border-color: #eff1f3 !important;
}
.fc.fc-direction-ltr .fc-dayGridMonth-view .fc-daygrid-day-top {
  flex-direction: row;
}
.fc.fc-direction-ltr .fc-dayGridMonth-view .fc-daygrid-day-top .fc-daygrid-day-number {
  float: left;
  padding: 0.5rem 1rem;
  width: 100%;
  box-sizing: border-box;
...
.fc .fc-daygrid-block-event .fc-event-time, .fc .fc-daygrid-block-event .fc-event-title {
  padding: 0;
}
.fc.fc-direction-ltr .fc-daygrid-event.fc-event-start, .fc.fc-direction-rtl .fc-daygrid-event.fc-event-end {
  margin-left: 9px;
  margin-right: 9px;
}
...
.react-bootstrap-table .caret:hover {
  cursor: pointer;
}
.react-bootstrap-table .dropup, .react-bootstrap-table .dropdown {
  position: relative;
}
...
.react-bootstrap-table .order-4:after, .react-bootstrap-table .caret-4-asc:after, .react-bootstrap-table .caret-4-desc:after {
  right: 0.5em;
  content: "#2193";
}
.react-bootstrap-table .order-4:before, .react-bootstrap-table .caret-4-asc:before, .react-bootstrap-table .caret-4-desc:before {
  right: 1em;
  content: "#2191";
}
.react-bootstrap-table .order-4:after, .react-bootstrap-table .order-4:before, .react-bootstrap-table .caret-4-asc:after, .react-bootstrap-table .caret-4-asc:before, .react-bootstrap-table .caret-4-desc:after, .react-bootstrap-table .caret-4-desc:before {
  position: absolute;
  bottom: 1.1em;
  display: block;
  opacity: 0.3;
...
.rna-wrapper .alert:hover {
  z-index: 1081 !important;
}
.rna-wrapper .alert:not(.alert-info):not(.alert-success):not(.alert-warning):not(.alert-danger) {
  background-color: rgba(0, 0, 0, 0.95);
}
.rna-wrapper .alert:not(.alert-info):not(.alert-success):not(.alert-warning):not(.alert-danger) .alert-notify-close {
  color: #ffd600;
}
.rna-wrapper .alert:not(.alert-info):not(.alert-success):not(.alert-warning):not(.alert-danger) .alert-notify-close:hover {
  opacity: 0.8;
}
.rna-wrapper .alert .ni[data-notify=icon] {
  position: relative;
  top: 4px;
}
.rna-wrapper .alert .alert-title {
  display: block;
  font-size: 1rem;
  font-weight: 600;
}
.rna-wrapper .alert .close {
  top: 1rem !important;
  right: 1.5rem !important;
  transform: translateY(0);
}
...
.bootstrap-tagsinput .tag a::after {
  font-size: 16px;
  content: "×";
}
...
.btn.btn-sm.btn-.btn-icon-only.text-light, .btn-group-sm > .btn.btn-.btn-icon-only.text-light {
  background-color: transparent;
}
...
.body-page-transition .page-transition-wrapper-div {
  margin: 100px auto;
  padding: 0px;
  max-width: 360px;
  text-align: center;
...
.body-page-transition .page-transition-icon-wrapper {
  display: block;
}

.container-stepper-wizard {
  padding-top: 24px;
  padding-bottom: 24px;
  display: table;
  width: 100%;
...
.container-stepper-wizard .step-outer-stepper-wizard {
  display: table-cell;
  position: relative;
}
.container-stepper-wizard .step-outer-stepper-wizard .shape-stepper-wizard {
  width: 70px;
  height: 70px;
...
.container-stepper-wizard .step-outer-stepper-wizard .shape-stepper-wizard .shape-content-stepper-wizard {
  font-size: 35px;
  line-height: 70px;
  color: green;
}
.container-stepper-wizard .step-outer-stepper-wizard .shape-stepper-wizard .disabled-stepper-wizard {
  position: absolute;
  top: 50%;
  left: 50%;
  transform: translate(-50%, -50%);
...
.container-stepper-wizard .step-outer-stepper-wizard .line-left-stepper-wizard {
  position: absolute;
  top: 35px;
...
.container-stepper-wizard .step-outer-stepper-wizard .line-right-stepper-wizard {
  position: absolute;
  top: 35px;
  border-top: 3px solid green;
  right: 0px;
...
.uploads-item:hover .uploads-item__delete {
  color: #ff1e50;
  background-color: #ffffff;
}
.uploads__add-button {
...
.uploads__add-button:hover {
  background-color: #447df7;
}
.uploads__add-button:hover i {
  color: #ffffff;
}
.uploads .input-area {
  margin-bottom: 10px;
}
.uploads .input-area:last-child {
  margin-bottom: 0;
}
.uploads_with-groups {
  justify-content: flex-start;
}
.uploads_with-groups .input-area {
  margin-left: 7px;
  margin-right: 7px;
}
.uploads_with-groups .input-area__content {
...
.fill-default {
  fill: #b2c74b !important;
}

.bg-default {
  background: #b2c74b !important;
}
...
.tuba-navbar .navbar-brand {
  display: block;
  padding-left: 20px;
}
.tuba-navbar .navbar-brand img {
  height: 100%;
}
.tuba-navbar .nav-top-line {
  display: flex;
  flex-wrap: nowrap;
  white-space: nowrap;
  justify-content: space-between;
...
@media (max-width: 700px) {
  ...
  .tuba-navbar .nav-top-line .top-cart {
    margin-top: 10px;
  }
...
.shop-sidebar .nav-item.active a {
  color: #0289c9 !important;
}
...
.color-chooser .color-active {
  -webkit-box-shadow: 4px 4px 10px 0 #282828;
  -moz-box-shadow: 4px 4px 10px 0 #282828;
  box-shadow: 4px 4px 10px 0 #282828;
}
...
.splide__arrow svg {
  ...
  fill: #92aba9 !important;
}

.organizer .categories .active {
  font-weight: bold;
}
...
.reviews-list .review--left {
  min-width: 250px;
  margin-right: 30px;
}
.reviews-list .review--left .review--name {
  font-weight: bold;
}
.reviews-list .review--left .review--stars img.icon {
  width: 20px;
  height: 20px;
}
.reviews-list .review--right {
  width: 100%;
  display: flex;
  background: #ECF0F1;
}
