    ...
    return (
      <React.Fragment>
        <Head>
          ...
          <meta
            name="description"
            content="Чарівний одяг, що створений з легкістю та любовʼю для Вас. Проект, що поєднує творчих людей. З радістю відповімо на ваші питання: 38 050 176 42 23"
          />
          <meta name="keywords" content="Дизайнерская одежда, Украина, Туба-Дуба, Tuba-Duba, женская одежда, дизайнерський одяг, жіночій одяг, Україна" />
          <meta property="og:title" content="Туба-дуба: простір легкості та краси" />
          <meta property="og:description" content="Одяг, який обіймає..." />
          <meta
